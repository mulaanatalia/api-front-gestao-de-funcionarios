...
$response = callapi($mainUrl . "treinamento/".$_GET['id'], "GET");
$data = $response->data;  // Convertendo a resposta JSON para um objeto PHP
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1 class="font-weight-bold">Detalhes do Treinamento</h1>
                </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <form action="" method="post">
                                    <input type="hidden" id="treinamento_id" value="<?= $_GET['id'] ?>">

                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-10 col-sm-9">
                                                    <?php $caminho = $response->data->caminho; ?>
                                                    <img id="imagemAluno" src="<?=!empty($response->data->caminho) ? "$caminho" : "dist-assets/images/user.png"?>" alt="Imagem do Aluno" class="img-fluid img-thumbnail rounded-circle avatar-xl mb-3">
                                                </div>
                                                <div class="col-md-10 col-sm-9">
                                        <div class="row">
                                            <div class="col-md-4 col-sm-6 mb-3">
                                                ...
                                                <p style="font-family:'Times New Roman', Times, serif; font-size: 14px; color: #2C304D; font-weight: 600;" class="form-control"><?= isset($data->data->nome) ? $data->data->nome : '' ?></p>
                                            </div>
                                            <div class="col-md-4 col-sm-6 mb-3">
                                                ...
                                                <p style="font-family:'Times New Roman', Times, serif; font-size: 14px; color: #2C304D; font-weight: 600;" class="form-control"><?= isset($data->data->descricao) ? $data->data->descricao : '' ?></p>
                                            </div>
                                            <div class="col-md-4 col-sm-6 mb-3">
                                                ...
                                                <p style="font-family:'Times New Roman', Times, serif; font-size: 14px; color: #2C304D; font-weight: 600;" class="form-control"><?= isset($data->data->duracao) ? $data->data->duracao : '' ?></p>
                                            </div>
                                        </div>
                                    </div>
