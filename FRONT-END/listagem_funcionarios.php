...
<body class="text-left">
    ...
    <script>
        ...
        //         // formulario.append("nome", $("#nome_funcionario").val())
        //         // formulario.append("provincia", $("#id_provincia_modal").val())
        //         // formulario.append("distrito", $("#id_distrito_modal").val())
        //         // formulario.append("departamento", $("#id_departamento").val())
        //         // formulario.append("genero", $("#genero_fun").val())
        //         // formulario.append("contacto", $("#contacto").val())
        //         // formulario.append("data_de_nascimento", $("#data_nascimento").val())
        ...
        //     });
            ...
            $(document).on("click", "#desactivar_funcionario", function() {  
                let id = $(this).val() 
                          
                $.ajax({
                url: './app/ajax/funcionario/desactivar.php',
                method: 'POST',
                data: {
                    "id": id,
                },
